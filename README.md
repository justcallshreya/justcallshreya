<div style="display: flex; align-items: center; justify-content: space-between; width: 100%; padding: 20px; background: linear-gradient(135deg, #0f2027, #203a43, #2c5364); border-radius: 12px; font-family: 'Segoe UI', sans-serif;">
  ...
  <div style="width: 25%; text-align: right;">
    <img src="https://media3.giphy.com/media/fMA7I4pIO9qNZsjCSu/giphy.gif?cid=6c09b952zilm47b6ds08roahv1tnshajgpd0zbhr20etl0dp&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=g" 
         alt="Coding Vibes" 
         width="200" 
